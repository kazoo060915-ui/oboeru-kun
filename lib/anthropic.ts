...

{
  ...
  "correct": "【例え話】＋【本質の説明】＋【身近な実例】＋【語呂合わせ/覚え方】の黄金4部構成で、初学者でも一発で腑に落ちるようにあなたのキャラクターの口調で丁寧に解説（5〜7文程度）。アスタリスク(**)は絶対使わない。\n1.【例え話】「ざっくり言うと○○みたいなもんや」という日常の例え（料理・コンビニ・引っ越し・日常生活など）\n2.【本質の仕組み】専門用語を即座にかみ砕いた言い換え付きで技術・概念の本当の仕組みを解説\n3.【身近な実例】Amazon, X (Twitter), YouTube, Google など誰もが知る有名サービスや日常での具体例\n4.【語呂合わせ/暗記フック】「頭文字で覚えるなら『S(すぐ)S(サーバーで)R(料理)』みたいに覚えると忘れないよ！」というクスッと笑えて記憶に残るフレーズの提案",
